...
const query=[{collection:'activity',orderBy:['timestamp','desc']}]
...
class EventDashboard extends Component{
      constRef=createRef();
      state={moreEvents:false,loadingInitial:true,loadedEvents:[]}
                  ...
                  <Grid>
                        <Grid.Column width={10}>
                              <div ref={this.contextRef}>
                                    ...
                                    events={loadedEvents} moreEvents={moreEvents} getNextEvents={this.getNextEvents}
                                    />
